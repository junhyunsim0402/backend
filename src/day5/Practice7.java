...
public class Practice7 {
    public static void main(String[] args) {
        ...
        player1.name="송흥민"; player1.power=90;player1.speed=95;
        Player player2=new Player();
        player2.name="이강인";player2.power=85;player2.speed=92;
        if(player1.speed+ player1.power>= player2.power+ player2.speed){
            System.out.printf("%s:%d\n",player1.name,player1.speed+ player1.power);
        }else{
        ...
        if(menu1.isSignature==true){System.out.println(menu1.name+menu1.price);}
        if(menu2.isSignature==true){System.out.println(menu2.name+menu2.price);}
        if(menu3.isSignature==true){System.out.println(menu3.name+menu3.price);}
